        ...
        headers: [
          ...
          },
          {
            ...
            value: [
              ...
              "connect-src 'self' https://paypercrawl.tech wss://paypercrawl.tech https://*.razorpay.com https://*.googleapis.com https://*.supabase.co",
              "frame-src https://checkout.razorpay.com https://api.razorpay.com https://accounts.google.com https://*.supabase.co",
            ].join("; "),
          },
        ],
      },
