...
**Your Resend API Key:** `***REDACTED_RESEND_KEY***`
...
**Your Neon Database:** `postgresql://neondb_owner:***REDACTED_DB_PASSWORD***@ep-steep-resonance-adkp2zt6-pooler.c-2.us-east-1.aws.neon.tech/neondb?sslmode=require&channel_binding=require`
...
3. ⚠️ **Switch to production database** by updating `.env`:
   ...
   DATABASE_URL="postgresql://neondb_owner:***REDACTED_DB_PASSWORD***@ep-steep-resonance-adkp2zt6-pooler.c-2.us-east-1.aws.neon.tech/neondb?sslmode=require&channel_binding=require"
   ```
