    ...
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        ...
        >
          ...
          <SunDim className="absolute h-[1.2rem] w-[1.2rem] rotate-90 scale-0 transition-all duration-300 dim:rotate-0 dim:scale-100 pulse-glow dark:rotate-90 dark:scale-0" />
