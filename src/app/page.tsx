          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 sm:gap-8">
            <FadeIn delay={0.1} className="h-full">
              <motion.div
                ...
                className="h-full"
              >
                <Card className="shadow-sm border-border/50 bg-card/50 backdrop-blur-sm transition-all duration-300 hover:shadow-md hover:border-primary/20 h-full">
                  <CardHeader className="text-center p-4 sm:p-6">
                    <div className="w-12 h-12 sm:w-16 sm:h-16 bg-primary/5 rounded-full flex items-center justify-center mx-auto mb-4">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-14 items-start">
            ...
            <FadeIn direction="left">
              <Card className="shadow-sm border-border/50 bg-card/50 backdrop-blur-sm order-1 lg:order-2 transition-all duration-300 hover:shadow-md hover:border-primary/20">
                <CardHeader className="p-4 sm:p-6">
                  <CardTitle className="text-lg sm:text-xl">
                    Market Validation
                  </CardTitle>
